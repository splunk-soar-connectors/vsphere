...
VSPHERE_ERR_INVALID_CONTENT_LENGTH = "Server returned an invalid content length"
...
VSPHERE_TASK_TIMEOUT_SECONDS = 600
VSPHERE_ERR_TASK_TIMEOUT = "Task '{task_name}' did not complete within {timeout} seconds (last state: {state})"
VSPHERE_MAX_PROPERTY_PAGES = 1000
VSPHERE_MAX_PROPERTY_OBJECTS = 100000
VSPHERE_PROPERTY_RETRIEVAL_TIMEOUT_SECONDS = 600
VSPHERE_ERR_PROPERTY_RETRIEVAL_LIMIT = "vSphere property retrieval exceeded its {limit_name} limit"
...
VSPHERE_VIRTUAL_MACHINE_NOT_CHANGED = (
